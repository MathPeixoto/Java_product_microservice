...
public class ProductRepositoryTest {
    ...
    public void findAllProductsGivenFiltersShouldReturnAListOfProducts() {
        Optional<List<ProductEntity>> allProducts = productRepository.findAllProducts(1, 0);
        List<ProductEntity> productEntityList = allProducts.orElseGet(() -> fail("The list of products is empty"));
